	...
	*/
	...
	var Flooper = (function () {
	  _createClass(Flooper, [{
	    ...
	    // Utility method to extend defaults with user options, no ES6 neither Object.Assign due browser support
	    value: function _extendDefaults(source, properties) {
	      var property;
	  ...
	  function Flooper(options) {
	    _classCallCheck(this, Flooper);
	
	    this._transformProp = (function () {
	    ...
	    if (options && typeof options === "object") {
	      this.options = this._extendDefaults(this.options, options);
	    }
	
	    this.left = 0;
	    this.bufferSize = this.options.bufferSize;
	    this.flooper = document.querySelector(this.options.flooper);
	    this.flooperItem = document.querySelectorAll(this.options.flooperItem);
	  ...
	  _createClass(Flooper, [{
	    ...
	    value: function update() {
	      ...
	      this.checkBlocks();
	      this.flooper.style[this._transformProp] = 'translateX(' + this.left + 'px)';
